                ...
                {images.length > 1 && (
                    <div className="mt-3 flex w-full items-center justify-between text-xs text-zinc-500">
                        <button
                            ...
                            className="flex min-h-11 items-center gap-1 rounded-full border border-zinc-300 px-2.5 py-1.5 hover:border-[#E31637] hover:text-zinc-800 transition-colors duration-500"
